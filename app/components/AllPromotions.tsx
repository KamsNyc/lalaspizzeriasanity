  ...
  return (
    <div className="deals-container p-8 bg-gray-50 mt-10">
      ...
      <div className="deal-item border-b pb-4 mb-4">
        ...
        <div className="deal-price text-green-600 font-medium">$9.99</div>
      </div>
      ...
      <div className="deal-item border-b pb-4 mb-4">
        ...
        <div className="deal-price text-green-600 font-medium">$24.99</div>
      </div>
      ...
      <div className="deal-item border-b pb-4 mb-4">
        ...
        <div className="deal-price text-green-600 font-medium">$1.00 extra</div>
      </div>
